"""
This File implements the functionalities of SpotMicroAI using PyBullet.
Copy of minitaur.py. Still adapting the code..
Here we try to close the RealityGap
"""
import copy
import math
import numpy as np
...
MOTOR_NAMES = [
    "front_left_shoulder_joint", "front_right_shoulder_joint", "rear_left_shoulder_joint","rear_right_shoulder_joint", 
    "front_left_leg_joint", "front_right_leg_joint", "rear_left_leg_joint","rear_right_leg_joint", 
    "front_left_foot_joint", "front_right_foot_joint", "rear_left_foot_joint","rear_right_foot_joint", 
]
    ...
    if reload_urdf:
      if self._self_collision_enabled:
        self.quadruped = self._pybullet_client.loadURDF(
            "%s/spotmicroai_gen.urdf.xml" % self._urdf_root,
            INIT_POSITION,
            flags=self._pybullet_client.URDF_USE_SELF_COLLISION)
      else:
        self.quadruped = self._pybullet_client.loadURDF(
            "%s/spotmicroai_gen.urdf.xml" % self._urdf_root, INIT_POSITION)
